package org.pyroclast.ai.Conditions 
{
	 ...
	 * @author John Lynk
	 */
	public class VelocityXCondition implements IStateCondition 
	{
		...
		public function VelocityXCondition( parent:FlxSprite, target:Number, equality:int) 
		{
			_parent = parent;
			_target = target;
			_function = equality;
		...
		public function test():Boolean 
		{
			...
			{
				case EQUALS:
					return _parent.velocity.x == _target;
					break;
				case NOT_EQUALS:
					return _parent.velocity.x != _target;
					break;
