package org.pyroclast.ai.Actions 
{
	 ...
	 * @author John Lynk
	 */
	public class ChaseAction implements IAIAction 
	{
		private var _parent:FlxSprite;
		private var _target:FlxSprite;
		private var _expiryTime:int = 0;
		private var _priority:int = 0;
		public function ChaseAction( parent:FlxSprite, target:FlxSprite ) 
		{
			_parent = parent;
			_target = target;
		}
		...
		public function execute():void 
		{
			...
			desiredVelocity.x = _target.x - _parent.x;
			desiredVelocity.y = _target.y - _parent.y;
